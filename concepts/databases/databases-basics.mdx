...
![CleanShot 2025-03-05 at 01.41.00.gif](attachment:cb2a5d8f-e1b9-4507-8944-39f49d944850:CleanShot_2025-03-05_at_01.41.00.gif)
...
![CleanShot 2025-03-05 at 01.49.29@2x.png](attachment:4071be52-990a-4e1a-a271-823e8840e5d1:CleanShot_2025-03-05_at_01.49.292x.png)**Tip #1** – To get a quick look at the structure of your data source, click the **table icon** to preview sample data.
...
**Note** – For HRIS databases, the process of adding a column is different. Please follow the steps here.

![CleanShot 2025-03-05 at 01.57.19@2x.png](attachment:e51a8792-6b06-495d-8506-4c7532b5d3a9:CleanShot_2025-03-05_at_01.57.192x.png)
...
![CleanShot 2025-03-05 at 02.01.03.gif](attachment:fe9b39a0-cc9e-40b8-bfc9-1c0f88f5500e:CleanShot_2025-03-05_at_02.01.03.gif)
...
![CleanShot 2025-03-05 at 02.04.19@2x.png](attachment:047c9c84-482e-4310-92ec-051026ee5070:CleanShot_2025-03-05_at_02.04.192x.png)
...
![CleanShot 2025-03-05 at 02.05.05@2x.png](attachment:0ab06d41-2b2c-4c98-b047-6042fef664f2:CleanShot_2025-03-05_at_02.05.052x.png)

To revert a driver column back to a single value, click on its name in the database header again and select **Show as value.**

![CleanShot 2025-03-05 at 02.05.55@2x.png](attachment:8e467307-9836-415b-8981-b24af35bfdd9:CleanShot_2025-03-05_at_02.05.552x.png)

**Note:** If you choose to display a different driver column as a time series, it will automatically replace the current one, which will revert to being displayed as a value.
...
![CleanShot 2025-03-05 at 02.12.50.gif](attachment:6458c785-c300-45a0-81fa-8dad921f7854:CleanShot_2025-03-05_at_02.12.50.gif)
...
![CleanShot 2025-03-05 at 02.15.04@2x.png](attachment:60e7f7a1-4be3-428d-9b05-e36fa798ffc9:CleanShot_2025-03-05_at_02.15.042x.png)

### Show & hide columns

For a more compact view of your data, you can hide columns that are not always relevant and show them only when needed.

You can do this by clicking on the column name in the database header and selecting **Hide in block.**

![CleanShot 2025-03-05 at 02.18.49@2x.png](attachment:2ace8de1-164b-45a4-86c9-71cffe04fb4d:CleanShot_2025-03-05_at_02.18.492x.png)
...
![CleanShot 2025-03-07 at 01.47.33@2x.png](attachment:f115a00d-f32a-4717-8200-5d19023b228d:CleanShot_2025-03-07_at_01.47.332x.png)
...
**Note** – For HRIS databases, the process of adding a row is different. Please follow the steps here.
...
![CleanShot 2025-03-07 at 01.57.12@2x.png](attachment:88b4ab67-ec6e-4c51-914b-8982e168c0c3:CleanShot_2025-03-07_at_01.57.122x.png)
...
![CleanShot 2025-03-07 at 01.56.01@2x.png](attachment:c077cb8e-5d13-43ec-b134-2091048b2c57:CleanShot_2025-03-07_at_01.56.012x.png)

### Deleting a row

To delete a row from a database, **right-click** on the row and select **Delete row.** Alternatively, press **`Shift` + `Backspace`**.

**Important:** Deleting a row removes it from the database, but it **does not delete the drivers** connected to that row. Any formulas relying on those drivers will remain unchanged, and the drivers will still be accounted for. These drivers will appear in your **Unlisted drivers** page.

To fully delete a driver and eliminate its impact on formulas, you need to delete it from the **Unlisted drivers** page.

![CleanShot 2025-03-07 at 02.05.58@2x.png](attachment:e27cea17-237b-4d4a-a920-e095922cc5e1:CleanShot_2025-03-07_at_02.05.582x.png)