...
description: "HRIS data is essential for modeling personnel-related expenses—often the largest cost for most businesses. HRIS databases in Runway now function like regular databases, making them easier to work with in formulas and models."
---

<Info>
  **Recent changes to HRIS databases**

  HRIS databases now work like standard dimensional databases in Runway. This means you can reference them directly in formulas and use them with the same data shaping patterns you're familiar with from other databases.
  
  However, when segmenting by dimensions that change over time (like Department or Job Title), there's a specific approach you'll need to follow. See our [headcount planning guide](https://docs.runway.com/guides/modeling/headcount-planning) for details.
</Info>
