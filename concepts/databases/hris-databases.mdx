...
You can also read our step-by-step guide on headcount modeling here (link coming soon).
...
### To surface HRIS data on a page
...
- References to segments in **other** databases are not currently supported. HRIS formulas can only reference columns within the same Employees database.
