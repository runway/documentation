...
![Rename Sidebar](/images/databases/3/rename-sidebar.png)
...
![Export Sidebar](/images/databases/3/export-sidebar.png)

Alternatively, navigate to the database, click the **More** icon in the top-right, and select **Export to CSV.**

![Export In Page](/images/databases/3/export-in-page.png)
...
![Delete](/images/databases/3/delete.png)
