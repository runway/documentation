...
1. When working in a database, click the **+** button at the far right to add a new column. In the menu, select **Dimension**.
   ...
   ![Add Dimension Column](/images/dimensions/add-dimension-column.png)
2. From there:
   - You can **search for an existing dimension** to reuse across multiple databases. Whenever possible, reuse existing dimensions rather than creating new ones to maintain your model's interconnectedness.
     ...
     ![Search Dimension Column](/images/dimensions/search-dimension-column.png)
   - Or, start typing a name and hit **Enter** to create **anew dimension** from scratch.

     ![Create Dimension Column](/images/dimensions/create-dimension-column.png)
...
- From any **dimension column** in a database, click the column header and select **Manage dimension**.
  ...
  ![Go To Dimension Settings](/images/dimensions/go-to-dimension-settings.png)
...
![Dimensions Settings](/images/dimensions/dimensions-settings.png)
