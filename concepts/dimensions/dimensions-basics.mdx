...
When viewing a dimension in the dimensions panel, you can see where it was sourced from. Dimensions created from integrations will display source information, making it easier to identify which dimensions came from connected systems like your General Ledger, HRIS, or CRM.
