---
title: "Drill-ins"
description: "When working in a model, drill-ins let you explore what contributes to a line and how your numbers connect throughout your model."
---
...
![Drill Ins](/images/drivers/drill-ins.gif)
...
For a full breakdown of roles and permissions, see [this guide](/guides/sharing/permissions).
...
2. **Explicitly add** selected drill-in drivers to the block:
   ...
   - Press `Cmd/Ctrl + Shift + B` or **right-click** → **Add to block** This will make those driver lines **visible to everyone.**
...
<Warning>
  **Drag-and-drop** to reorder is **not supported** for drill-in lines. **Undo/redo** is not supported for drill-in lines.
</Warning>
