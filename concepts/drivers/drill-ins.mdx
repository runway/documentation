...
description: "When working in a model, you might find yourself asking: What contributes to this line? Where does this number come from?

Drill-ins (currently in beta) allow you to explore these relationships, showing exactly how your numbers connect throughout your model."
...
<Check>
  Drill-ins **support multiple levels** of depth—expand an input line further to
  see its underlying dependencies.
</Check>
