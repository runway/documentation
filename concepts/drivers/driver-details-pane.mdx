...
6.  **Format** – Adjusts display settings for numeric drivers. \[Link: Formatting article\]
...
10. **Actuals formula** – Expanded space for editing the driver’s actuals formula. \[Link: Driver Formulas\]
11. **Forecast formula** – Expanded space for editing the driver’s forecast formula. \[Link: Driver Formulas\]
12. **Driver type** – Clearly indicates whether the driver stores **Numbers or Dates**. \[Link: Driver Types article\]
...
17. **Plans** – Displays any Plans applied to this driver. \[Link: Plans article (coming soon)\]
