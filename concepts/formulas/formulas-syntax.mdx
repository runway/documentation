...
- **Dates:** Use the format `'YYYY-MM-DD'` — you can use either single or double quotes (e.g., `'2025-06-01'` or `"2025-06-01"`). You can also write a date in the format `'YYYY'` and Runway will auto-populate as the first day of the month. (e.g., if you type `'2025'` Runway will populate `'01-01-2025'` .
