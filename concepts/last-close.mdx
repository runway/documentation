...
![Lastclose](/images/last-close/lastclose.gif)
...
- In a driver table block on a [model](https://docs.runway.com/concepts/models/models-basics) or [page](https://docs.runway.com/concepts/pages/drivers-table-block):
  ...
  ![Lastclose In Model](/images/last-close/lastclose-in-model.png)
- In the [detail pane](https://docs.runway.com/concepts/drivers/driver-details-pane) for a driver:

  ![Lastclose In Details Pane](/images/last-close/lastclose-in-details-pane.png)
- When you [expand a database column as a time series](https://docs.runway.com/concepts/databases/databases-basics#show-a-column-as-timeseries):
  ...
  ![Lastclose In Db](/images/last-close/lastclose-in-db.png)
- When displaying the entire [database as timeseries](https://docs.runway.com/concepts/databases/databases-basics#show-all-columns-as-timeseries):
  ...
  ![Lastclose In Db As Timeseries](/images/last-close/lastclose-in-db-as-timeseries.png)
- On a [chart](https://docs.runway.com/concepts/pages/charts-block):

  ![Lastclose In Charts](/images/last-close/lastclose-in-charts.png)
...
1. **After monthly close** Once your accounting books are closed, move last close forward by one month to reflect the latest actuals in your model. This is typically the [**first step in running a BvA**](https://docs.runway.com/guides/modeling/bva) (Budget vs. Actuals) comparison.
...
- **Hardcoded forecast value with no actuals formula**
  ...
  ![Hardcode 1](/images/last-close/hardcode-1.gif)
- **Conflicting hardcoded actuals and forecasts** If you’ve hardcoded a value **before last close**, and a different hardcoded value for the same month **after last close**, the actuals-side hardcode will take precedence when last close moves forward. For example, if March 2025 has a hardcoded actual of **10M** and a hardcoded forecast of **20M**, moving last close forward into March will display the **10M** value. Move last close back, and the **20M** forecast reappears.
  ...
  ![Hardcodes2](/images/last-close/hardcodes2.gif)
