...
- **Models** are structured tables where each row represents **adriver**. You can include:
...
2. [**Expanding drivers by dimensions**](https://docs.runway.com/concepts/dimensions/segmenting-drivers#segmenting-drivers-in-a-model-using-expand-by-dimension)
...
![Model Create](/images/models/model-create.gif)
...
- [**Change the time period rollup**](/concepts/pages/drivers-table-block#time-period-rollups-quarter-year-etc) (e.g. monthly, quarterly, annual)
