...
By default, each driver is displayed separately, but you can **combine multiple drivers** into a **single chart** for a more consolidated view.![](/images/pages/charts/combine-drivers.png)
...
If you want data labels to always be visible instead of only showing on hover, turn on the **Data labels** toggle.![](/images/pages/charts/data-labels.png)
...
![](/images/pages/charts/legend.png)
...
![](/images/pages/charts/axis-settings.png)
...
![images/pages/charts/scenarios.gif](/images/pages/charts/scenarios.gif)
