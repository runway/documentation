...
By default, each driver is displayed separately, but you can **combine multiple drivers** into a **single chart** for a more consolidated view.![Combine Drivers](/images/pages/charts/combine-drivers.png)
