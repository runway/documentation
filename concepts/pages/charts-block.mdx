...
- **Line** - **Column** - **Stacked column** - **100% stacked column** - **Value** - **Area** - **Combo** - **Waterfall** - **Pie** - **Donut**

![Types](/images/pages/charts/types.png)

### Combine charts

By default, each driver is displayed separately, but you can **combine multiple drivers** into **asingle chart** for a more consolidated view.![Combine Drivers](/images/pages/charts/combine-drivers.png)

### Chart size

You can choose from three chart block sizes: **small, medium, and large.** - **Small** works best for **value charts** if you want a more compact layout.
- **Large** is better for more detailed charts like **combo or stacked column charts**, making them easier to read.

![Chart Size](/images/pages/charts/chart-size.png)

### Data labels

If you want data labels to always be visible instead of only showing on hover, turn on the **Data labels** toggle.![Data Labels](/images/pages/charts/data-labels.png)
...
![Legend](/images/pages/charts/legend.png)
...
- **Change driver color**– Click the button next to a driver's name to update its color. Choose from **10 default vibrant colors** or select **acustom color** by clicking the multi-color circle.
...
![Driver Config](/images/pages/charts/driver-config.png)

<Note>
  If you're using **waterfall charts**, the per-driver customizations work differently to better suit this chart type. More details can be found [here](https://docs.runway.com/concepts/pages/charts-block#waterfall-charts-specific-customizations).
</Note>
...
- Move the **X-axis** from **bottom to top** - Show or hide **asolid line** for each axis
- Show or hide **axis ticks** - Add **atitle** to each axis

![Axis Settings](/images/pages/charts/axis-settings.png)
...
![Date Range](/images/pages/charts/date-range.png)

### Rollups

You can add quarterly and annual rollups to your timeseries charts. This allows you to view aggregated data at different time granularities directly on your charts.

To add rollups:

1. Click **Customize chart** on your chart block.
2. Select **Rollups**.
3. Choose from **Quarterly**, **Annual**, or both.

The rollup values will appear alongside your monthly data, making it easy to see trends at different time scales.

<Note>
  Rollups only work on timeseries charts (line, column, area, combo). They are not available for non-timeseries chart types like sankey, value, or waterfall charts.
</Note>
...
![Waterfall](/images/pages/charts/waterfall.png)
...
![Scenarios](/images/pages/charts/scenarios.gif)

## Exporting charts

You can download a **chart block** in two ways:

1. **Export the data as a CSV**– Click the **six-dot button** on the top left of the block and select **"Export to CSV."** 2. **Download the chart as a PNG**–**Right-click** on the chart and select **Download.**

![Export Chart](/images/pages/charts/export-chart.png)

## Charts FAQs

<Accordion title="Can I view my chart data by quarters or years instead of just months?" defaultOpen="false">
  Yes! You can add quarterly and annual rollups to timeseries charts. Click **Customize chart**, select **Rollups**, and choose **Quarterly**, **Annual**, or both. Note that rollups are only available for timeseries chart types (line, column, area, combo) and not for charts like sankey, value, or waterfall.
</Accordion>
