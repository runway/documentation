...
- **Plan timeline** – Create a timeline of your Plans and apply filters to limit which ones appear on your page. More on Plans block here (LINK: coming soon).
...
![images/pages/basics/drag-blocks.gif](/images/pages/basics/drag-blocks.gif)

When placing blocks side by side, you can **resize** them by **dragging the handle** between them.

![images/pages/basics/resizing-blocks.gif](/images/pages/basics/resizing-blocks.gif)
