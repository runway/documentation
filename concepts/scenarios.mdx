...
- Changes to the 'view' of tables — like updating filters, sorts, groups, and visible columns
...
![images/scenarios/compare-tables.gif](/images/scenarios/compare-tables.gif)
