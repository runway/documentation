...
4. You will see Income Statement Amount at all of the segmentations of your databases. Select **Income Statement Amount Account Type** to pull in the 5 most aggregated drivers at the top of your income statement onto the page
5. 