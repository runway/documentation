...
description: "A P&L model serves as the basis for your financial reporting and forecasting needs. This guide explains how to build a customizable P&L from your General Ledger data."
---
...
3. Click `edit` In the **database configuration menu** and choose the following inputs:
   ...
   - Add **Other columns** that will serve as metadata for your segments and be used to group, filter and categorize your GL data
     ...
     ![Level 1 income statement database configuration](/images/guides/p-and-l-level-1-database-config.png)
4. Click **Confirm** to load the database

   ![Level1dboutput](/images/PandL/Level1dboutput.png)
...
6. Click **Confirm**
   ...
   <video muted autoplay="true" loop controls playsinline="true" class="doc-video" src="/videos/p-and-l-database-hierarchy.mp4" />
...
![Income statement database hierarchy in the sidebar](/images/guides/p-and-l-sidebar-database-stack.png)
...
2. Add a [drivers table block](https://docs.runway.com/concepts/pages/drivers-table-block) by pressing the / key for options
...
![Searching for income statement drivers on a page](/images/guides/p-and-l-page-driver-search.png)
...
5. Pages have affordances to create new drivers and build formulas, like for Gross Profit
   ...
   <video muted autoplay="true" loop controls playsinline="true" class="doc-video" src="/videos/addinggrossprofit.mp4" />
6. You can add drivers to the report via drill-in. If you click the caret to the left of any driver, you will see the sequential drill down through the database stack you constructed.
   ...
   ![Drillinpandl](/images/PandL/drillinpandl.png)
