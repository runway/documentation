...
6. You can add drivers to the report via [drill-in](https://docs.runway.com/concepts/drivers/drill-ins). If you click the carat to the left of any driver, you will see the sequential drill down through the database stack you constructed.
...
By using **segments**, [**lookup tables**](https://docs.runway.com/guides/modeling/lookups), and **databases** you can transform raw ledger data into a clean, structured, and drillable income statement.

For more advanced analysis, use your income statement output to compare [**budget vs. actuals**](https://docs.runway.com/guides/modeling/bva), track trends, or [share ](https://docs.runway.com/guides/sharing/adding-users)summaries with stakeholders.