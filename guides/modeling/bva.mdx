...
![LastClose](/images/LastClose.gif)
...
- To customize variance color, right-click a driver, click `Format and display` → `Comparison color`, and choose Positive variance is green or Positive variance is red.
...
![Images](/images/CleanShot2025-09-10at12.43.01.gif)
