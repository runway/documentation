...
2. **Check the columns** containing numbers or dates you plan to use in your model.
   ...
   ![Step1 Drivers](/images/cohorts/step1-drivers.png)
...
![Step1 Segment By](/images/cohorts/step1-segment-by.png)
...
1. **Apply forecast formulas** to match actuals where needed.
   ...
   ![Step2](/images/cohorts/step2.gif)
...
1. Add a driver for **cohort age**
   ...
   ![Step3](/images/cohorts/step3.png)
...
1. **Create a new database and segment it by:** - **Cohort Age** (as a dimension)
...
![Step4](/images/cohorts/step4.png)
...
![Step5](/images/cohorts/step5.png)
...
1. **Create a new database** 2. Set its **source** to your **Cohort Model** database
...
<video muted autoplay="true" loop controls playsinline="true" class="doc-video" src="/videos/cohorts-step6.mp4" />
