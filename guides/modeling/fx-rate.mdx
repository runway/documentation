...
![Step1 Sheet](/images/fx/step1-sheet.png)
...
5. In the setup flow:
   ...
   - Under **Segment by**, select both:
     ...
     - `TO_CURRENCY` — the currency you are converting **into.** 6. Click **Confirm** to finish setting up the database.

![Step3 Query](/images/fx/step3-query.png)
...
5. In the **Default Forecast**, enter your conversion formula:
   ...
   ![Step4 Formula](/images/fx/step4-formula.png)
