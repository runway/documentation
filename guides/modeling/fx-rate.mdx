...
3. In cell **A1**, use the `IMPORTRANGE` function to pull in exchange rates from Runway’s live FX sheet ([link](https://docs.google.com/spreadsheets/d/1gAsVhuVDFbXsztrOShUc8bNEFTEa8h7LIInYUXc1opQ/edit?usp=sharing)), powered by [XE.com](http://xe.com/)—the same rates used by QuickBooks and Xero:
