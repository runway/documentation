...
The first step is getting your employee data into Runway. The recommended approach is to connect to one of our available HRIS integrations. See our guides [here](/integrations/hris/rippling) for our most common HRIS integrations.

![Headcount Step1 Database](/images/headcount/headcount-step1-database.png)
...
<Tabs>
  ...
  <Tab title="Legacy HRIS databases">
    ...
    1. **Create a headcount driver in a model** Whether in a new model or existing one, select **+ Add Driver** and create one called Headcount.

       ![Headcount Step2 Create Driver](/images/headcount/headcount-step2-create-driver.png)
    2. **Expand Headcount driver by the appropriate dimension**
       ...
       ![Headcount Step2 Expand](/images/headcount/headcount-step2-expand.png)
    ...
    3. **Build the headcount formula for one of the drivers** Double-click into the **forecast formula** cell of the first dimensional driver and type `count()` to leverage the built-in count function.

       ![Headcount Step3 Count Formula](/images/headcount/headcount-step3-count-formula.png)
       ...
       ![Headcount Step3 Count Formula Filters](/images/headcount/headcount-step3-count-formula-filters.png)
    ...
    5. **Sum your headcount**
       ...
       - **Sum new drivers** — Double-click into the **forecast formula** cell and type `sum` to leverage the sum function. Within the parentheses, type Headcount. The first option you will see is Headcount [Department], which references the collective dimensional drivers that you just created.
         ...
         ![Headcount Step3 Sum](/images/headcount/headcount-step3-sum.png)
       - **Sum driver group** — If you put your Headcount drivers into their own driver group (shift + select them cmd + G), you have the option to sum the group itself. Double-click into the **forecast formula** cell and type sum to leverage the sum function. Within the parentheses, search for the driver group name and scroll in the dropdown to the driver group section. This will sum every driver within this group except for the one you're typing in.
         ...
         ![Headcount Step3 Sum Group](/images/headcount/headcount-step3-sum-group.png)
       - **Sum the database directly** — If you find that you won't be leveraging dimensions as much for your Headcount breakdown, you can always sum the database itself for a total. Follow the instructions in Step 3 but omit the Department filter and you'll have a full count of your active employees.

         ![Headcount Step3 Sum Database](/images/headcount/headcount-step3-sum-database.png)
  </Tab>
</Tabs>
...
![Headcount Step4 Add Employee](/images/headcount/headcount-step4-add-employee.png)
...
![Headcount Step4 Drill In](/images/headcount/headcount-step4-drill-in.png)
