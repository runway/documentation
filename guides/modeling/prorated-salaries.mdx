...
![Prorated Salaries Step1 Create Field](/images/prorated-salaries/prorated-salaries-step1-create-field.png)
...
![Prorated Salaries Step2 1](/images/prorated-salaries/prorated-salaries-step2-1.png)
...
![Prorated Salaries Step2 2](/images/prorated-salaries/prorated-salaries-step2-2.png)

3. Use `daysInMonth()` to divide by the total days in the month and calculate the prorated percentage.

![Prorated Salaries Step2 3](/images/prorated-salaries/prorated-salaries-step2-3.png)

4. Multiply this prorated fraction by the employee's monthly salary (annual salary divided by 12).

![Prorated Salaries Step2 4](/images/prorated-salaries/prorated-salaries-step2-4.png)
...
![Prorated Salaries Step3](/images/prorated-salaries/prorated-salaries-step3.png)
...
![Prorated Salaries Step4 Final Formula](/images/prorated-salaries-step4-final-formula.png)
...
![Prorated Salaries Step4 Save](/images/prorated-salaries/prorated-salaries-step4-save.png)
