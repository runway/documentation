...
![Comment option on a Runway cell](/images/sharing/comments/comment-on-cell.png)
...
![Comment indicator on a Runway cell](/images/sharing/comments/comment-indicator.png)
...
Note that giving your teammates "Edit" access is not too risky to Main Scenario. If they change any of the content, Runway will push them to a draft scenario automatically. Only Admins have permissions to merge changes into Main proper.
