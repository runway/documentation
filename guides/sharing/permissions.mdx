...
- **Pages, models, databases**
  ...
  - Their access can be adjusted to `Can edit`, `Can view`, or `No access`.
  - Can create new ones.
...
- **Pages, models, databases**
  ...
  - Access can be adjusted to `Can edit`, `Can view`, or `No access`.
...
You can learn how to adjust access levels from the **Share** menu in [this article](https://docs.runway.com/guides/sharing/adding-users#adding-users-via-share-menu).