...
1. A **NetSuite administrative account** 2. The [**SuiteAnalytics Connect Service**](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/book_N748613.html) enabled, with access to either the [**NetSuite.com**](http://NetSuite.com) or [**NetSuite2.com**](http://NetSuite2.com) data source.

## Setting up NetSuite via Fivetran

![Netsuite Fivetran Template](/images/integrations/netsuite-fivetran-template.png)
...
4. For the **Schema Name**, leave it as `netsuite_suiteanalytics`.
   ...
   ![Netsuite Fivetran Schema](/images/integrations/netsuite-fivetran-schema.png)
...
<Accordion title="Can you bring in custom columns, fields or lists from NetSuite?">
  ...
  - Bonus: A screenshot from NetSuite’s **Record Explorer** showing how the field is defined.
    ...
    ![Netsuite Record Explorer](/images/integrations/netsuite-record-explorer.png)
</Accordion>
