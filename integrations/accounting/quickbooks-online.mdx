...
![QuickBooks Fivetran](/images/integrations/quickbooks-fivetran.png)
...
4. For the **Schema Name**:
   ...
   - If connecting **multiple QuickBooks instances**, update the **Schema Name** with a unique identifier (e.g., `quickbooks_us`, `quickbooks_ltd`). ![QuickBooks Fivetran Schema Name](/images/integrations/quickbooks-fivetran-schema-name.png)
...
![QuickBooks Template](/images/integrations/quickbooks-template.png)
