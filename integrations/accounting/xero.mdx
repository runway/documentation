...
| ------------ | ------------ | ----------- | --------------------------------------------------- |
| Journal Date | Mar 28, 2024 | _Date Driver_ | Via Template - used to group by Month in timeseries |

**Balance sheet data**

| Data name    | Example     | Data type   | Availability                                        |
| ------------ | ----------- | ----------- | --------------------------------------------------- |
| Report Month | Mar 1, 2024 | _Date Driver_ | Via Template - used to group by Month in timeseries |
|              |             |             |                                                     |
|              |             |             |                                                     |
|              |             |             |                                                     |
