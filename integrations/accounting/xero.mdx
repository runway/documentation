...
| BS Account Name \
(without number) | Chase Checking        | Dimension     | Can be added                                        |
...
| -------------------------------- | ----------------------- | ------------- | --------------------------------------------------- |
| Journal Date                     | Mar 28, 2024            | Date Driver   | Via Template - used to group by Month in timeseries |
| CF Account Name                  | 2001 - Accounts Payable | _Dimension_   | via Template                                        |
| CF Account Name \
(without number) | Accounts Payable        | Dimension     | Can be added                                        |
