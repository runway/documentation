...
![Sheets Long Data](/images/integrations/sheets/sheets-long-data.png)
...
![Sheets Wide Data](/images/integrations/sheets/sheets-wide-data.webp)
...
- **Format date columns properly** - **Long data**: Use **MM/DD/YYYY** format.
...
1. Open Runway, navigate to **Integrations**, and install the Google Sheets integration listed under the **Spreadsheets** section.
   ...
   ![Sheets Spreadsheet](/images/integrations/sheets/sheets-spreadsheet.png)
2. Click **Sign in with Google** and leave the other settings as default.

   ![Sheets Spreadsheet Setup](/images/integrations/sheets/sheets-spreadsheet-setup.png)
3. Once redirected back into **Runway**, click **+** next to integration name in the sidebar to create a new query.

   ![Create Query](/images/integrations/hubspot/create-query.png)
4. You can then change the default query name, **New query**, to something more descriptive. To do this, click the **three-dots button** next to the query name in the sidebar and select **Rename query**.
   ...
   ![Rename Query](/images/integrations/hubspot/rename-query.png)
5. In **Google Sheets**, navigate to the tab you want to import into Runway. Add `#runway` to the tab name to ensure Runway recognizes it.
   ...
   ![Sheets Spreadsheet Tab](/images/integrations/sheets/sheets-spreadsheet-tab.png)
...
7. Paste the **Spreadsheet ID** into Runway and click **Run Query**.
   ...
   ![Sheets Spreadsheet Id](/images/integrations/sheets/sheets-spreadsheet-id.png)
8. Verify the data preview:
   - If you see a column named **month** and a column named **value**, Runway successfully converted your **wide data** into **along data set**.
...
[Here’s a video walkthrough of these steps](https://www.loom.com/share/a6f08d1a57884baebd702697c6f9f807).
 ...
 1. Open **Runway**, navigate to **Integrations**, and install the **Google Sheets integration** listed under the **Fivetran** section.
    ...
    ![Sheets Fivetran](/images/integrations/sheets/sheets-fivetran.png)
 2. Leave the **Schema Name** as the default and enter a **Table Name** that accurately represents the data.
    ...
    ![Sheets Fivetran Setup](/images/integrations/sheets/sheets-fivetran-setup.png)
 ...
 5. In **Google Sheets**, open your spreadsheet in **anew tab** and **share it with that email address** as **aviewer**.
 6. Select the **headers of the data you want to import** (they must be side by side—**you cannot skip columns**) and create **anamed range.** Navigate to **Data \> Named Range**, then give it **aunique and descriptive name**.

    ![Data Range](/images/integrations/sheets/data-range.gif)
...
14. Copy the **suggested commented query**, paste it below in the SQL editor, and click **Run query**.
    ...
    ![Sheets Fivetran Commented Query](/images/integrations/sheets/sheets-fivetran-commented-query.gif)
...
<Accordion title="How often does this sheet sync to Runway?" icon="sparkles">
  ...
  ![Resync](/images/integrations/resync.png)
</Accordion>
