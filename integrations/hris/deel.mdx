...
Follow these steps to integrate **Deel** with Runway and automatically sync your HR data:![Deel](/images/deel.png)
...
<Accordion title="Does Runway write data back to Deel?" defaultOpen={false}>
...
<Accordion title="Can I connect additional HRIS sources?" defaultOpen={false}>
  Yes! To add more integration sources, go to the Integrations Directory in Runway, search for the integration you need, and follow the setup flow. Check out our [Integration documentation](/integrations/intro-to-integrations) for guidance on our most popular integrations.
</Accordion>
