...
<Accordion title="Can I connect additional HRIS sources?" defaultOpen={false}>
  Yes! To add more integration sources, go to the **Integrations Directory** in Runway, search for the integration you need, and follow the setup flow. Check out our **Integration Help Center** for guidance on our most popular integrations.
</Accordion>