...
Follow these steps to connect **Justworks** to Runway and automatically sync your employee data:![Justworks](/images/justworks.png)
...
<Accordion title="Does Runway write data back to Justworks?" defaultOpen={false}>
...
<Accordion title="Does the Justworks integration send only base salary values or fully-loaded employee costs?" defaultOpen={false}>
