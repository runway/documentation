...
3. Search for **Salesforce** and click **+ Set up** on the option listed in the **CRM** section.
   ...
   ![Salesforce Workato](/images/integrations/salesforce-workato.png)
...
7. Copy the **Salesforce Report ID** from your report's URL and paste it into the highlighted field below.
   ...
   ![Salesforce Workato Report Id](/images/integrations/salesforce-workato-report-id.png)
...
## **SQL-powered integration via Fivetran** 1. Click **Setup** on the **Salesforce (Fivetran)** integration in the Integrations directory and follow the on-screen authentication process.

   ![Salesforce Fivetran](/images/integrations/salesforce-fivetran.png)
2. Keep the default settings during Fivetran setup.

   ![Salesforce Fivetran Config](/images/integrations/salesforce-fivetran-config.png)
3. After being redirected back to **Runway**, we recommend using our **Salesforce Opportunities** integration template.
   ...
   ![Salesforce Fivetran Template](/images/integrations/salesforce-fivetran-template.png)
