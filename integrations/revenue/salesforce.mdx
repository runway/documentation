...
9. You’re done integrating\! [Go ahead and configure a new database.](https://www.notion.so/Databases-basics-1ae691424a288035817ae31f2a0729b5?pvs=21)
...
<Accordion title="What objects does Runway have access to?" icon="sparkles">
...
<Accordion title="How does a deal land in a time series?" icon="sparkles">
