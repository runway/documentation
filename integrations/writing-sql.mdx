...
<Warning>
  You **cannot** write SQL to **join data warehouse sources with Fivetran
  integrations** within Runway.
</Warning>
...
Now that your queries are complete and your integration is set up, [learn how to shape a database.](https://www.notion.so/Databases-basics-1ae691424a288035817ae31f2a0729b5?pvs=21)
